...
[![GitHub](https://img.shields.io/badge/GitHub-0D1117?style=for-the-badge\&logo=github\&logoColor=white)](https://github.com/suleymanbakar39)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-E30A17?style=for-the-badge\&logo=linkedin\&logoColor=white)](https://linkedin.com/in/suleyman-bakar-836113199)
[![Mail](https://img.shields.io/badge/Contact-FFFFFF?style=for-the-badge\&logo=gmail\&logoColor=black)](mailto:suleymanbakar39@gmail.com)
...
|     🛡️ SECURITY    |    ⚙️ BACKEND   |       🧠 RESEARCH      |
| :-----------------: | :-------------: | :--------------------: |
|     Web Security    | API Development | Vulnerability Analysis |
| Penetration Testing |  Authentication |   Secure Architecture  |
|      DevSecOps      | Database Design |      Cryptography      |
...
Hassas verilerin korunması ve uygulama güvenliğinin yönetilmesi amacıyla geliştirdiğim güvenlik odaklı platform.

`AES-256-GCM` · `TOTP` · `RBAC` · `SAST` · `Secret Detection`
...
Java, PHP ve MySQL kullanılarak geliştirilen etkinlik ve bilet yönetim platformu.
...
`SQLi` · `XSS` · `LFI` · `Authentication` · `Authorization`

**PENETRATION TESTING**

`Nmap` · `Metasploit` · `Kali Linux`

**SECURE DEVELOPMENT**

`Cryptography` · `RBAC` · `2FA` · `Secure APIs`
...
<img src="https://github-readme-stats.vercel.app/api?username=suleymanbakar39&show_icons=true&hide_border=true&bg_color=0D1117&title_color=E30A17&icon_color=E30A17&text_color=FFFFFF"/>

<br>

<img src="https://github-readme-streak-stats.herokuapp.com/?user=suleymanbakar39&hide_border=true&background=0D1117&ring=E30A17&fire=E30A17&currStreakLabel=E30A17&sideLabels=FFFFFF&dates=888888"/>
...
# `GÜVENLİK BİR ÖZELLİK DEĞİL, TEMELDİR.`

**Cyber Security • Backend • Secure Software**

<br>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0D1117,50:E30A17,100:0D1117&height=120&section=footer"/>
